...
#ifndef __compressor_faddfsbkb__HH__
#define __compressor_faddfsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compressor_faddfsbkb) {
    ...
    SC_CTOR(compressor_faddfsbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
