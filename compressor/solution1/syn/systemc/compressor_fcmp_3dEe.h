...
#ifndef __compressor_fcmp_3dEe__HH__
#define __compressor_fcmp_3dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compressor_fcmp_3dEe) {
    ...
    SC_CTOR(compressor_fcmp_3dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
