...
set Library     "hls"
set IPName      "compressor"
set Version     "1.0"
set DisplayName "Compressor"
set Revision    "1904282010"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 thresh W 0x0 "Data signal of thresh" {{0 32 thresh W 0 "Bit 31 to 0 Data signal of thresh"}}} {0x18 slope W 0x0 "Data signal of slope" {{0 32 slope W 0 "Bit 31 to 0 Data signal of slope"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS in_V out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 19 II x}
...
set enable_xo_gen 0
set kernel_files {/root/workspace/compressor/compressor.cpp}
if {$enable_xo_gen} {
